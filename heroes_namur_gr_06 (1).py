...
def initialization(board_file):
    ...
    dico_player1: Level, number of point, etc. of the heroes of player1 (dict)
    dico_player2: Level, number of point, etc. of the heroes of player2 (dict)
...
def game():
    ...
    """
#Function 7.5 
def gap_calculator(dico_positions):
...
def creature_turn(dico_positions, dico_creatures, dico_player1, dico_player2):
    ...
    -----------
    dico_positions: Contains all the coordinates of the board (dict)   
 dico_creatures: Has every information of each creature (dict)
    dico_player1: Level, number of point, etc. of heroes of player1 (dict)
    dico_player2: Level, number of point, etc. of heroes of player2 (dict)

    Returns:
    --------
    dico_positions: Contains all the coordinates of the board (dict)    dico_player1: Level, number of point, etc. of heroes of player1 (dict)
    dico_player2: Level, number of point, etc. of heroes of player2 (dict)
