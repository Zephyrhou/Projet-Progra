...
def energise(positions, hero_name, player1, player2, modif):
    ...
    # Level of the hero = 3
    elif updated[hero_name]['level'] == 3:
        for heroes in updated:
    ...
    # Level of the hero = 4
    elif updated[hero_name]['level'] == 4:
        for heroes in updated:
            if gap_calculator(positions, hero_name, heroes) <= 3:
                updated[heroes]['damage_points'] += 2
    ...
    # Level of the hero = 5
    elif updated[hero_name]['level'] == 5:
        for heroes in updated:
    ...
    if used >= 1:
        updated[heroes]['cooldown']['energise'] += 1
    else:
...
def stun(positions, player_1, player_2, creatures, hero_name, modif):
    ...
    # Level of the hero = 3
    if updated[hero_name]['level'] == 3:
        # For the heroes of the other player
        for heroes in updated:
            if gap_calculator(positions, hero_name, heroes) == 1:
                if updated[heroes]['damage_points'] >= 2:
                    updated[heroes]['damage_points'] -= 1
                    modif[heroes]['damage_points_modifs'] -= 1
                    used += 1
        ...
        for enemies in creatures:
            if gap_calculator(positions, hero_name, enemies) == 1:
                if creatures[enemies]['damage_points'] >= 2:
                    creatures[enemies]['damage_points'] -= 1
                    modif[enemies]['damage_points_modifs'] -= 1
                    used += 1
    ...
    # Level of the hero = 4
        ...
        for heroes in updated:
            if gap_calculator(positions, hero_name, heroes) <= 2:
                if updated[heroes]['damage_points'] >= 3:
                    updated[heroes]['damage_points'] -= 2
                    modif[heroes]['damage_points_modifs'] -= 2
                    used += 1
                    print(heroes + "'s damage points have been decreased by 2 for this turn")
                else:
                    print(heroes + "'s damage points haven't been modified")
            else:
                print(heroes + "'s damage points haven't been modified")
        ...
        for enemies in creatures:
            if gap_calculator(positions, hero_name, enemies) <= 2:
                if creatures[enemies]['damage_points'] >= 3:
                    creatures[enemies]['damage_points'] -= 2
                    modif[enemies]['damage_points_modifs'] -= 2
                    used += 1
                    print(enemies + "'s damage points have been decreased by 2 for this turn")
                else:
                    print(enemies + "'s damage points haven't been modified")
            else:
                print(enemies + "'s damage points haven't been modified")
    ...
    # Level of the hero = 5
        ...
        for heroes in updated:
            if gap_calculator(positions, hero_name, heroes) <= 3:
                if updated[heroes]['damage_points'] >= 4:
                    updated[heroes]['damage_points'] -= 3
                    modif[heroes]['damage_points_modifs'] -= 3
                    used += 1
                    print(heroes + "'s damage points have been decreased by 3 for this turn")
                else:
                    print(heroes + "'s damage points haven't been modified")
            else:
                print(heroes + "'s damage points haven't been modified")
        ...
        for enemies in creatures:
            if gap_calculator(positions,hero_name, enemies) <= 3:
                if creatures[enemies]['damage_points'] >= 4:
                    creatures[enemies]['damage_points'] -= 3
                    modif[enemies]['damage_points_modifs'] -= 3
                    used += 1
                    print(enemies + "'s damage points have been decreased by 3 for this turn")
                else:
                    print(enemies + "'s damage points haven't been modified")
            else:
                print(enemies + "'s damage points haven't been modified")
...
def invigorate(positions, hero_name, player1, player2, max_life_points, modif):
    ...
    updated, bad_dict = good_dict(hero_name)
    used = 0
    ...
    if updated[hero_name]['level'] == 2:
            for heroes in updated:
                if gap_calculator(positions, hero_name, heroes) == 1:
                    ...
                    # Ally = barbarian
                    if updated[heroes]['job'] == 'barbarian':

                        # Barbarian level == 1
                        if updated[heroes]['level'] == 1:
                            if updated[heroes]['life_points'] < max_life_points['barbarian'][1]:
                                updated[heroes]['life_points'] += 1
                                modif[heroes]['life_points_modifs'] += 1
                                used += 1
                                print(heroes + "' health points have been increased by one for this turn")
                            else:
                                print(heroes + "' health points haven't been modified")

                        # Barbarian level == 2
                        if updated[heroes]['level'] == 2:
                            if updated[heroes]['life_points'] < max_life_points['barbarian'][2]:
                                updated[heroes]['life_points'] += 1
                                modif[heroes]['life_points_modifs'] += 1
                                used += 1
                                print(heroes + "' health points have been increased by one for this turn")
                        ...
                        # Barbarian level == 3
                        if updated[heroes]['level'] == 3:
                            if updated[heroes]['life_points'] < max_life_points['barbarian'][3]:
                                updated[heroes]['life_points'] += 1
                                modif[heroes]['life_points_modifs'] += 1
                                used += 1
                                print(heroes + "' health points have been increased by one for this turn")
                        ...
                        # Barbarian level == 4
                        if updated[heroes]['level'] == 4:
                            if updated[heroes]['life_points'] < max_life_points['barbarian'][4]:
                                updated[heroes]['life_points'] += 1
                                modif[heroes]['life_points_modifs'] += 1
                                used += 1
                                print(heroes + "' health points have been increased by one for this turn")
                        ...
                        # Barbarian level == 5
                            ...
                            if updated[heroes]['life_points'] < max_life_points['barbarian'][5]:
                                updated[heroes]['life_points'] += 1
                                modif[heroes]['life_points_modifs'] += 1
                                used += 1
                                print(heroes + "' health points have been increased by one for this turn")
                    ...
                    # Ally = healer
                    if updated[heroes]['job'] == 'healer':

                        # Healer level == 1
                        if updated[heroes]['level'] == 1:
                            if updated[heroes]['life_points'] < max_life_points['healer'][1]:
                                updated[heroes]['life_points'] += 1
                                modif[heroes]['life_points_modifs'] += 1
                                used += 1
                                print(heroes + "' health points have been increased by one for this turn")
                        ...
                        # Healer level == 2
                        if updated[heroes]['level'] == 2:
                            if updated[heroes]['life_points'] < max_life_points['healer'][2]:
                                updated[heroes]['life_points'] += 1
                                modif[heroes]['life_points_modifs'] += 1
                                used += 1
                                print(heroes + "' health points have been increased by one for this turn")
                        ...
                        # Healer level == 3
                        if updated[heroes]['level'] == 3:
                            if updated[heroes]['life_points'] < max_life_points['healer'][3]:
                                updated[heroes]['life_points'] += 1
                                modif[heroes]['life_points_modifs'] += 1
                                used += 1
                                print(heroes + "' health points have been increased by one for this turn")
                        ...
                        # Healer level == 4
                        if updated[heroes]['level'] == 4:
                            if updated[heroes]['life_points'] < max_life_points['healer'][4]:
                                updated[heroes]['life_points'] += 1
                                modif[heroes]['life_points_modifs'] += 1
                                used += 1
                                print(heroes + "' health points have been increased by one for this turn")
                    ...
                    # Ally = mage
                    if updated[heroes]['job'] == 'mage':

                        # Mage level == 1
                        if updated[heroes]['level'] == 1:
                            if updated[heroes]['life_points'] < max_life_points['mage'][1]:
                                updated[heroes]['life_points'] += 1
                                modif[heroes]['life_points_modifs'] += 1
                                used += 1
                                print(heroes + "' health points have been increased by one for this turn")
                        ...
                        # Mage level == 2
                        if updated[heroes]['level'] == 2:
                            if updated[heroes]['life_points'] < max_life_points['mage'][2]:
                                updated[heroes]['life_points'] += 1
                                modif[heroes]['life_points_modifs'] += 1
                                used += 1
                                print(heroes + "' health points have been increased by one for this turn")
                        ...
                        # Mage level == 3
                        if updated[heroes]['level'] == 3:
                            if updated[heroes]['life_points'] < max_life_points['mage'][3]:
                                updated[heroes]['life_points'] += 1
                                modif[heroes]['life_points_modifs'] += 1
                                used += 1
                                print(heroes + "' health points have been increased by one for this turn")
                        ...
                        # Mage level == 4
                        if updated[heroes]['level'] == 4:
                            if updated[heroes]['life_points'] < max_life_points['mage'][4]:
                                updated[heroes]['life_points'] += 1
                                modif[heroes]['life_points_modifs'] += 1
                                used += 1
                                print(heroes + "' health points have been increased by one for this turn")
                        ...
                        # Mage level == 5
                            ...
                            if updated[heroes]['life_points'] < max_life_points['mage'][5]:
                                updated[heroes]['life_points'] += 1
                                modif[heroes]['life_points_modifs'] += 1
                                used += 1
                                print(heroes + "' health points have been increased by one for this turn")
                    ...
                    # Ally = rogue
                    if updated[heroes]['job'] == 'rogue':

                        # Rogue level == 1
                        if updated[heroes]['level'] == 1:
                            if updated[heroes]['life_points'] < max_life_points['rogue'][1]:
                                updated[heroes]['life_points'] += 1
                                modif[heroes]['life_points_modifs'] += 1
                                used += 1
                                print(heroes + "' health points have been increased by one for this turn")
                        ...
                        # Rogue level == 2
                        if updated[heroes]['level'] == 2:
                            if updated[heroes]['life_points'] < max_life_points['rogue'][2]:
                                updated[heroes]['life_points'] += 1
                                modif[heroes]['life_points_modifs'] += 1
                                used += 1
                                print(heroes + "' health points have been increased by one for this turn")
                        ...
                        # Rogue level == 3
                        if updated[heroes]['level'] == 3:
                            if updated[heroes]['life_points'] < max_life_points['rogue'][3]:
                                updated[heroes]['life_points'] += 1
                                modif[heroes]['life_points_modifs'] += 1
                                used += 1
                                print(heroes + "' health points have been increased by one for this turn")
                        ...
                        # Rogue level == 4
                        if updated[heroes]['level'] == 4:
                            if updated[heroes]['life_points'] < max_life_points['rogue'][4]:
                                updated[heroes]['life_points'] += 1
                                modif[heroes]['life_points_modifs'] += 1
                                used += 1
                                print(heroes + "' health points have been increased by one for this turn")
                        ...
                        # Rogue level == 5
                            ...
                            if updated[heroes]['life_points'] < max_life_points['rogue'][5]:
                                updated[heroes]['life_points'] += 1
                                modif[heroes]['life_points_modifs'] += 1
                                used += 1
                                print(heroes + "' health points have been increased by one for this turn")
            ...
            for heroes in updated:
                if gap_calculator(positions,hero_name, heroes) == 2:
                    ...
                    if updated[heroes]['job'] == 'barbarian':
                        ...
                        # Barbarian level == 1
                        if updated[heroes]['level'] == 1:
                            max_health = max_life_points['barbarian'][1] - 2
                            if updated[heroes]['life_points'] <= max_health:
                                updated[heroes]['life_points'] += 2
                                modif[heroes]['life_points_modifs'] += 2
                                used += 1
                                print(heroes + "' health points have been increased by one for this turn")
                            else:
                                print(heroes + "' health points haven't been modified")
                        ...
                        # Barbarian level == 2
                        if dict[heroes]['level'] == 2:
                            max_health = max_life_points['barbarian'][2] - 2
                            if updated[heroes]['life_points'] <= max_health:
                                updated[heroes]['life_points'] += 2
                                modif[heroes]['life_points_modifs'] += 2
                                used += 1
                        ...
                        # Barbarian level == 3
                        if updated[heroes]['level'] == 3:
                            max_health = max_life_points['barbarian'][3] - 2
                            if updated[heroes]['life_points'] <= max_health:
                                updated[heroes]['life_points'] += 2
                                modif[heroes]['life_points_modifs'] += 2
                                used += 1
                        ...
                        # Barbarian level == 4
                        if updated[heroes]['level'] == 4:
                            max_health = max_life_points['barbarian'][4] - 2
                            if updated[heroes]['life_points'] <= max_health:
                                updated[heroes]['life_points'] += 2
                                modif[heroes]['life_points_modifs'] += 2
                                used += 1
                        ...
                        # Barbarian level == 5
                            ...
                            max_health = max_life_points['barbarian'][5] - 2
                            if updated[heroes]['life_points'] < max_health:
                                updated[heroes]['life_points'] += 2
                                modif[heroes]['life_points_modifs'] += 2
                                used += 1
                    ...
                    if updated[heroes]['job'] == 'healer':
                        ...
                        # Healer level == 1
                        if updated[heroes]['level'] == 1:
                            max_health = max_life_points['healer'][1] - 2
                            if updated[heroes]['life_points'] <= max_health:
                                updated[heroes]['life_points'] += 2
                                modif[heroes]['life_points_modifs'] += 2
                                used += 1
                        ...
                        # Healer level == 2
                        if updated[heroes]['level'] == 2:
                            max_health = max_life_points['healer'][2] - 2
                            if updated[heroes]['life_points'] <= max_health:
                                updated[heroes]['life_points'] += 2
                                modif[heroes]['life_points_modifs'] += 2
                                used += 1
                        ...
                        # Healer level == 3
                        if updated[heroes]['level'] == 3:
                            max_health = max_life_points['healer'][3] - 2
                            if updated[heroes]['life_points'] <= max_health:
                                updated[heroes]['life_points'] += 2
                                modif[heroes]['life_points_modifs'] += 2
                                used += 1
                        ...
                        # Healer level == 4
                        if updated[heroes]['level'] == 4:
                            max_health = max_life_points['healer'][4] - 2
                            if updated[heroes]['life_points'] <= max_health:
                                updated[heroes]['life_points'] += 2
                                modif[heroes]['life_points_modifs'] += 2
                                used += 1
                        ...
                        # Healer level == 5
                            ...
                            max_health = max_life_points['healer'][5] - 2
                            if updated[heroes]['life_points'] <= max_health:
                                updated[heroes]['life_points'] += 2
                                modif[heroes]['life_points_modifs'] += 2
                                used += 1
                    ...
                    if updated[heroes]['job'] == 'mage':
                        ...
                        # Mage level == 1
                        if updated[heroes]['level'] == 1:
                            max_health = max_life_points['mage'][1] - 2
                            if updated[heroes]['life_points'] <= max_health:
                                updated[heroes]['life_points'] += 2
                                modif[heroes]['life_points_modifs'] += 2
                                used += 1
                        ...
                        # Mage level == 2
                        if updated[heroes]['level'] == 2:
                            max_health = max_life_points['mage'][2] - 2
                            if updated[heroes]['life_points'] <= max_health:
                                updated[heroes]['life_points'] += 2
                                modif[heroes]['life_points_modifs'] += 2
                                used += 1
